    ...
    <Layout>
      ...
      <section className="py-16 bg-accent">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <Badge variant="secondary" className="mb-6">About O.Tech</Badge>
            ...
            <div className="space-y-12">
              {timeline.map((item, index) => (
                <div key={index} className={`relative flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                  {/* Branch line */}
                  <div className={`absolute w-16 h-0.5 bg-primary/30 top-1/2 ${index % 2 === 0 ? 'left-1/2' : 'right-1/2'}`}></div>
                  ...
                  {/* Content */}
                  <div className={`w-5/12 ${index % 2 === 0 ? 'ml-auto pl-20' : 'mr-auto pr-20'}`}>
